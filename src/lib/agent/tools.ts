  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        chart_x: { type: 'string', description: 'x-axis column (optional)' },
        chart_y: { type: 'string', description: 'y-axis column (optional)' },
        chart_series: { type: 'string', description: 'series column for multi-series charts (optional)' },
